  ...
  <div>
    ...
    <div v-if="!started">
      ...
      <input id="size"
             ...
             name="size"
             size="3"> x {{ size }} -
      <label for="bombs">Mines: </label>
      <input id="bombs"
             v-model="bombs"
             type="number"
             name="bombs"
             size="3">
      <button @click="start">Commencer <i class="i-play" /></button>
    </div>
    <!-- /New game and options -->
    ...
    <div v-else class="board">
      ...
      <div class="grid" :class="{debug}">
        ...
        <!-- Line -->
        <div v-for="(line, index) in grid" :key="index" class="line">
          <!-- Cell -->
          <div v-for="(c, cIndex) in line"
               :key="cIndex"
               class="cell"
               :class="cellClass(c)"
               @click="trigger(c)"
